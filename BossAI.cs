...
public class BossAI : MonoBehaviour
{
    ...
    [Header("Poise System (New!)")]
    public float maxPoise = 100f;        // Total "Stance" health
    public float poiseRegenDelay = 5.0f; // Seconds without taking damage before poise refills
    public float poiseRegenRate = 10f;   // How fast it refills per second
    public float staggerDuration = 2.0f; // How long he stays stunned
    public string staggerAnimTrigger = "Hurt"; // The name of your hurt animation trigger

    // Debug helper to see poise in Inspector
    ...
    [Header("AI Tools (Movement & Range)")]
    ...
    private bool isStaggered = false; // New State
    ...
    void Start()
    {
        ...
        currentPoise = maxPoise; // Fill poise at start
    ...
    // --- NEW: POISE DAMAGE FUNCTION ---
    // CALL THIS from your Player Weapon script!
    // Example: bossAI.TakePoiseDamage(20);
